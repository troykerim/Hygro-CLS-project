...
#
# hygro_cls_proj.tcl: Tcl script for re-creating project 'hygro_cls_proj'
#
# Generated by Vivado on Sun Jun 15 11:49:43 PDT 2025
...
#
# 1. This project restoration tcl script (hygro_cls_proj.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/troy/Hygro-CLS-project/hardware/hygro_cls_proj/hygro_cls_proj.srcs/constrs_1/imports/contraints/zybo_z7-10.xdc"
#    "/home/troy/Hygro-CLS-project/hardware/hygro_cls_proj/hygro_cls_proj.srcs/utils_1/imports/synth_1/zynq_system_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/hardware/hygro_cls_proj/hygro_cls_proj.srcs/constrs_1/imports/contraints/zybo_z7-10.xdc"]"\
 "[file normalize "$origin_dir/hardware/hygro_cls_proj/hygro_cls_proj.srcs/utils_1/imports/synth_1/zynq_system_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "hygro_cls_proj"
...
set script_file "hygro_cls_proj.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/hardware/hygro_cls_proj"]"
...
set file "[file normalize ${origin_dir}/hardware/hygro_cls_proj/hygro_cls_proj.srcs/constrs_1/imports/contraints/zybo_z7-10.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "contraints/zybo_z7-10.xdc"
...
set file "synth_1/zynq_system_wrapper.dcp"
...
proc cr_bd_zynq_system { parentCell } {
  ...
  set CLS_out [ create_bd_intf_port -mode Master -vlnv digilentinc.com:interface:pmod_rtl:1.0 CLS_out ]

  set DDR [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:ddrx_rtl:1.0 DDR ]

  set FIXED_IO [ create_bd_intf_port -mode Master -vlnv xilinx.com:display_processing_system7:fixedio_rtl:1.0 FIXED_IO ]

  set HYGRO_out [ create_bd_intf_port -mode Master -vlnv digilentinc.com:interface:pmod_rtl:1.0 HYGRO_out ]
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net PmodCLS_0_Pmod_out [get_bd_intf_ports CLS_out] [get_bd_intf_pins PmodCLS_0/Pmod_out]
  connect_bd_intf_net -intf_net PmodHYGRO_0_Pmod_out [get_bd_intf_ports HYGRO_out] [get_bd_intf_pins PmodHYGRO_0/Pmod_out]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins PmodCLS_0/AXI_LITE_SPI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins PmodHYGRO_0/AXI_LITE_IIC] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins PmodHYGRO_0/AXI_LITE_TMR] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PmodCLS_0/ext_spi_clk] [get_bd_pins PmodCLS_0/s_axi_aclk] [get_bd_pins PmodHYGRO_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins PmodCLS_0/s_axi_aresetn] [get_bd_pins PmodHYGRO_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PmodHYGRO_0/AXI_LITE_IIC/Reg0] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PmodHYGRO_0/AXI_LITE_TMR/Reg0] -force
...
if { [get_property IS_LOCKED [ get_files -norecurse zynq_system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/hardware/hygro_cls_proj/hygro_cls_proj.gen/sources_1/bd/zynq_system/hdl/zynq_system_wrapper.vhd" ]
} else {
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/hygro_cls_proj.srcs/utils_1/imports/synth_1/zynq_system_wrapper.dcp" -objects $obj
